...
class RecipeDraft(Base):
    ...
    # ALTER TABLE recipe_drafts ADD COLUMN approval_status VARCHAR(50) DEFAULT 'DRAFT';
    ...
    # versions and approvals now reference recipes.id directly; no back-refs here.
...
class RecipeNetworkProfile(Base):
    ...
    segmentation_strategy: Mapped[str] = mapped_column(String(50), nullable=False)
    default_subnet_mask: Mapped[int] = mapped_column(Integer, nullable=False)
...
class RecipeNetworkDomain(Base):
    ...
    description: Mapped[Optional[str]] = mapped_column(Text)
    public_ingress_enabled: Mapped[bool] = mapped_column(Boolean, default=False)
    allow_inter_domain_routing: Mapped[bool] = mapped_column(Boolean, default=False)
...
class RecipeWorkloadUnit(Base):
    ...
    unit_key: Mapped[str] = mapped_column(String(100), nullable=False)
    functional_role: Mapped[Optional[str]] = mapped_column(String(100))
    network_position_index: Mapped[Optional[int]] = mapped_column(Integer)
    ...
    connectivity_profile: Mapped[Optional[str]] = mapped_column(String(100))
...
class RecipeAutomationProfile(Base):
    ...
    bootstrap_reference: Mapped[Optional[str]] = mapped_column(Text)
    initialization_reference: Mapped[Optional[str]] = mapped_column(Text)
    health_check_reference: Mapped[Optional[str]] = mapped_column(Text)
...
class RecipeGatewayExposureRule(Base):
    ...
    unit_key: Mapped[Optional[str]] = mapped_column(String(100))
    internal_port: Mapped[Optional[int]] = mapped_column(Integer)
    transport_protocol: Mapped[Optional[str]] = mapped_column(String(20))
